...
CREATE TABLE "StoreSettings" (
    ...
    "storeName" TEXT NOT NULL DEFAULT 'روضه ستور',
    "whatsappNumber" TEXT NOT NULL DEFAULT '01080055206',
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
