        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-stone-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 border border-stone-200 rounded-xl p-2.5 text-xs font-bold text-stone-700 hover:bg-stone-50 transition"
            >
